    ...
    const ee = {
        ...
        breakpoints: {
            setBreakpoint: function() {
                ...
                const l = (n in r ? r[n] : void 0) || e.originalParams, o = Z(e, a), d = Z(e, l), c = e.params.grabCursor, u = l.grabCursor, m = a.enabled;
            ...
            s({
                ...
                setTranslate: ()=>{
                    ...
                    for(let s = 0; s < e.length; s += 1){
                        ...
                        const r = t.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(e.progress), 0) : 1 + Math.min(Math.max(e.progress, -1), 0), n = pe(0, e);
...
//# sourceMappingURL=index.574d1d7d.js.map
